...
CREATE TABLE `exam_section` (
  ...
  `Type` varchar(1) DEFAULT NULL COMMENT 'A - Automatic\nM - Manual',
  PRIMARY KEY (`Id`),
  KEY `es_tid_idx` (`TemplateId`),
  CONSTRAINT `es_tid` FOREIGN KEY (`TemplateId`) REFERENCES `exam_template` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
LOCK TABLES `exam_section` WRITE;
...
CREATE TABLE `exam_template` (
  ...
  PRIMARY KEY (`Id`),
  KEY `et_mcode_idx` (`ModuleCode`),
  CONSTRAINT `et_mcode` FOREIGN KEY (`ModuleCode`) REFERENCES `module` (`Code`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
LOCK TABLES `exam_template` WRITE;
/*!40000 ALTER TABLE `exam_template` DISABLE KEYS */;
INSERT INTO `exam_template` VALUES (1,'CS1101','CS1101 Introduction to Programming AY2014/2015 Semester 1 Examination','2014-11-14 02:15:09'),(2,'CS1101','CS1101 Introduction to Programming AY2014/2015 Semester 2 Examination','2014-11-15 02:15:09'),(3,'CS1102','CS1102 Data Structure and Algorithm AY2014/2015 Semester 2 Examination','2014-11-15 02:15:09');
...
INSERT INTO `module` VALUES ('CS1101','Introduction to Programming',21,1),('CS1102','Data Structure and Algorithm',12,1),('CS2101','Computer Organization',0,1),('CS2102','Software Engineering',0,1),('MA1105','Discrete Mathematics',0,1);
...
INSERT INTO `question_part` VALUES (1,37,'A',3),(2,37,'B',17),(3,37,'C',18),(4,37,'D',24),(5,38,'B',24),(6,38,'C',26),(7,38,'A',19),(8,38,'D',28),(11,40,'A',1),(12,40,'B',3),(13,41,'B',29),(14,41,'D',3),(15,41,'C',29),(16,41,'A',3),(17,43,'A',3),(18,43,'B',28),(19,43,'C',29);
...
INSERT INTO `question_tag` VALUES (1,1,1),(2,2,1),(3,3,1),(4,4,1),(5,5,2),(6,6,2),(7,7,2),(8,8,2),(9,9,2),(10,10,2),(11,11,2),(12,12,2),(13,13,2),(14,14,2),(15,15,2),(16,16,2),(17,28,1),(18,28,2),(19,29,1),(20,30,1),(21,31,1),(22,32,1),(23,33,1),(24,33,10),(25,34,1),(26,34,10),(27,35,1),(28,36,1),(29,37,1),(30,40,1),(31,41,1),(32,42,1),(33,43,1);
...
CREATE TABLE `section_question` (
  ...
  PRIMARY KEY (`Id`),
  KEY `sq_qid_idx` (`QuestionId`),
  KEY `secq_sid` (`SectionId`),
  CONSTRAINT `secq_qid` FOREIGN KEY (`QuestionId`) REFERENCES `question` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `secq_sid` FOREIGN KEY (`SectionId`) REFERENCES `exam_section` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `section_question`
--

LOCK TABLES `section_question` WRITE;
/*!40000 ALTER TABLE `section_question` DISABLE KEYS */;
/*!40000 ALTER TABLE `section_question` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2014-11-15 17:48:51
